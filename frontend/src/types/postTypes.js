...
export const POSTS_GET_POPULAR_REQUEST = 'POSTS_GET_POPULAR_REQUEST'
export const POSTS_GET_POPULAR_SUCCESS = 'POSTS_GET_POPULAR_SUCCESS'
export const POSTS_GET_POPULAR_ERROR = 'POSTS_GET_POPULAR_ERROR'
...
export const POST_UPDATE_CLEAR = 'POST_UPDATE_CLEAR'

export const POST_DELETE_REQUEST = 'POST_DELETE_REQUEST' 
export const POST_DELETE_SUCCESS = 'POST_DELETE_SUCCESS' 
export const POST_DELETE_ERROR = 'POST_DELETE_ERROR'
export const POST_DELETE_CLEAR = 'POST_DELETE_CLEAR'